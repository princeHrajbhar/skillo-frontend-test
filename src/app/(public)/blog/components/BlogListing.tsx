    ...
    <div className="min-h-screen bg-gray-50 py-8">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="max-w-3xl mx-auto mb-8">
          <form onSubmit={handleSearch} className="flex flex-col sm:flex-row gap-3">
            ...
            <div className="flex gap-3">
              ...
              <button
                type="submit"
                className="px-6 sm:px-8 py-3.5 bg-gradient-to-r from-[#016ab7] to-[#6cb84d] hover:shadow-lg hover:shadow-[#016ab7]/25 text-white font-semibold rounded-xl transition-all shadow-sm flex items-center gap-2 text-sm"
              >
          ...
          {categories.length > 0 && (
            <div className="flex flex-wrap items-center justify-center gap-2 mt-4">
              ...
              {categories.length > 6 && (
                <span className="text-xs text-gray-500">+{categories.length - 6} more</span>
              )}
            </div>
          )}
        </div>
        ...
        <div className="flex flex-wrap items-center justify-center gap-4 sm:gap-6 mb-8">
          ...
          <div className="flex items-center gap-2.5 bg-white px-4 py-2.5 rounded-full border border-gray-200 shadow-sm">
            <UserIcon className="h-5 w-5 text-[#016ab7]" />
            <span className="text-sm font-semibold text-gray-700">Expert Authors</span>
          </div>
        </div>
